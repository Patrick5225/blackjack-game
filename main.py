'''
This program simulates the card game of BlackJack, with some
limitations. The game involves one player versus the dealer.

The code used in this file is structured with an emphasis on
